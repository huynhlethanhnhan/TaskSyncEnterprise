...
const DashboardPage: React.FC = () => {
  ...
  // ROW 2: 6 Primary Executive KPI Cards
  const kpis = [
    {
      title: 'Dự án Active',
  ...
  return (
    <div className="space-y-6 font-sans pb-12">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold text-text-primary tracking-tight">
                Chào mừng trở lại, {user?.full_name || user?.name || 'Quản trị viên'}!
              </h1>
      ...
      {/* 📈 ROW 3: Recharts Business Intelligence Visualizations */}
      ...
      {/* 📋 ROW 4: Recent Activities Timeline, Feeds & Pending Approvals */}
      ...
      {/* 🗓️ ROW 5: Upcoming Deadlines, Birthdays & Events */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Upcoming Deadlines */}
        <Card>
          <CardHeader>
      ...
      {/* 📊 ROW 6: Workforce & Task Allocation Table */}
