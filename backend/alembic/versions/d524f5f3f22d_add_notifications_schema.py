...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "notification_type IN (N'AUTHENTICATION', N'TASKS', N'PROJECTS', N'VACATION', N'COMMENTS', N'SYSTEM')",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "delivery_status IN (N'PENDING', N'PROCESSING', N'SENT', N'FAILED', N'READ', N'ARCHIVED')",
            name="ck_dbo_notification_logs_delivery_status",
        ),
        sa.ForeignKeyConstraint(
            ["notification_id"], ["dbo.notifications.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="dbo",
    )
    op.create_index(
        op.f("ix_dbo_notification_logs_id"),
        "notification_logs",
        ["id"],
        unique=False,
        schema="dbo",
    ...
    op.create_index(
        op.f("ix_dbo_notification_logs_notification_id"),
        "notification_logs",
        ["notification_id"],
        unique=False,
        schema="dbo",
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            server_default=sa.text("N'SYSTEM'"),
            nullable=False,
        ),
        schema="dbo",
    )
    op.add_column(
        ...
        sa.Column(
            ...
            server_default=sa.text("N'NORMAL'"),
            nullable=False,
        ),
        schema="dbo",
    )
    ...
    op.add_column(
        ...
        sa.Column(
            "channel",
            sa.Unicode(length=20),
            server_default=sa.text("N'IN_APP'"),
            nullable=False,
        ),
        schema="dbo",
    )
    op.add_column(
        "notifications",
        sa.Column("event_id", sa.Unicode(length=50), nullable=True),
        schema="dbo",
    )
    op.add_column(
        "notifications",
        sa.Column("context_json", sa.UnicodeText(), nullable=True),
        schema="dbo",
    )
    op.add_column(
        "notifications",
    ...
    op.create_index(
        op.f("ix_dbo_notifications_employee_id"),
        "notifications",
        ["employee_id"],
        unique=False,
        schema="dbo",
    ...
    op.create_index(
        op.f("ix_dbo_notifications_event_id"),
        "notifications",
        ["event_id"],
        unique=False,
        schema="dbo",
    ...
    op.create_index(
        op.f("ix_dbo_notifications_type"),
        "notifications",
        ["type"],
        unique=False,
        schema="dbo",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_dbo_notifications_type"), table_name="notifications", schema="dbo"
    )
    op.drop_index(
        op.f("ix_dbo_notifications_event_id"), table_name="notifications", schema="dbo"
    )
    op.drop_index(
        op.f("ix_dbo_notifications_employee_id"),
    ...
    op.drop_constraint(
        "ck_dbo_notifications_priority", "notifications", schema="dbo", type_="check"
    )
    op.drop_constraint(
        "ck_dbo_notifications_status", "notifications", schema="dbo", type_="check"
    )
    op.drop_constraint(
        "ck_dbo_notifications_channel", "notifications", schema="dbo", type_="check"
    )
