...
class BackgroundJobService:
    ...
    def enqueue(self, task_func: Callable[..., Any], *args: Any, **kwargs: Any) -> None:
        ...
        if self.background_tasks is not None:
            ...
            app_logger.info(f"Enqueued background task '{task_func.__name__}' using FastAPI BackgroundTasks")
        else:
            ...
            app_logger.info(f"Enqueued background task '{task_func.__name__}' using ThreadPoolExecutor fallback")

    def _wrap_task(self, task_func: Callable[..., Any], *args: Any, **kwargs: Any) -> Callable[[], None]:
        ...
        def wrapper() -> None:
            ...
            try:
                ...
                app_logger.info(f"Background job '{task_name}' completed successfully in {duration:.4f}s")
...
def get_background_job_service(background_tasks: BackgroundTasks) -> BackgroundJobService:
