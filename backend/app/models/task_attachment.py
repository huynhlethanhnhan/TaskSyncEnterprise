...
class TaskAttachment(Base):
    ...
    file_name: Mapped[str] = mapped_column(String(255))      # Tên file gốc (VD: bao_cao.pdf)
    file_path: Mapped[str] = mapped_column(String(500))      # Đường dẫn vật lý trên server hoặc link MinIO
    ...
    task = relationship("Task", back_populates="attachments" if hasattr(Base, "_decl_class_registry") else None)