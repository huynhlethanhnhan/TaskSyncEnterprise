...
def deprecate_endpoint(sunset: str | None = None, link: str | None = None) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    """
...
class APIDeprecationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        if route and hasattr(route, "endpoint"):
            ...
            is_deprecated = getattr(route, "deprecated", False) or getattr(endpoint, "__deprecated_api__", False)
