...
def get_notification(
    ...
    if current_user.role_id != ROLE_ADMIN and notification.employee_id != current_user.id:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Access denied. You can only view your own notifications."
        )
...
def mark_notification_as_read(
    ...
    updated_notif = notification_service.mark_as_read(db, notification_id, notification.employee_id)
    return ResponseBuilder.success(
        data=updated_notif,
